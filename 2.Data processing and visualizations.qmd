...
```{r}
# Set theme for plots (very minimal)
...
# Open access colour trends over 10 years (stream graph)
...
# Sen's slope calculation for determining trend

An alternative to the raw counts is to calculate the increase in the percentage of OA over time. Because raw numbers aren't used, this might reduce the effect of the increase in publication counts.
